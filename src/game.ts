...
addBook1(75.5, 2, -11.6 - 0.075 * 1, 270, 0, 180)
addBook1(75.5, 2, -11.6 - 0.065, 270, 180.0, 180)
addBook1(75.5, 2, -11.6 - 0.075 * 3, 270, 0, 180)
addBook1(75.5, 2, -11.6 - 0.075 * 4, 270, 0, 180)
addBook1(75.5, 2, -11.6 - 0.075 * 5, 270, 0, 180)
addBook1(75.5, 2, -11.6 - 0.075 * 6, 270, 0, 180)
addBook1(75.5, 2, -11.6 - 0.075 * 7, 270, 0, 180)
addBook1(75.5, 2, -11.6 - 0.075 * 8, 270, 0, 180)
addBook1(75.5, 2, -11.6 - 0.075 * 9, 270, 0, 180)

addBook2(75.5, 0.9, -11.9, 0, 30, 0)

addBooks(75.4, 1.58, -9.88, 0, 34, 0)

addBook4(74.57, 0.08, -13.13)
...
// addLowStonePillar(-62 + 1.5 * 8 + pillarOff, 0, -15.54);
// addLowStonePillar(-62 + 1.5 * 8 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 19 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 18 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 17 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 16 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 15 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 14 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 13 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 12 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 11 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 10 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 9 + pillarOff, 0, -15.54);
addLowStonePillar(-62 + 1.5 * 8 + pillarOff, 0, -15.54);
...
addMagicSerpentStone(-18.36, 0, 31.30)
addMagicStone(-15, 0, 79.03)
