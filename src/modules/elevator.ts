...
class elevatorSystem {
    ...
    movePlatform() {
        ...
        this.platform.addComponent(new utils.MoveTransformComponent(this.firstFloorPos, this.secondFloorPos, 3, null, utils.InterpolationType.EASEOUTSINE))

        let delayEnt = new Entity()
        delayEnt.addComponent(new utils.Delay(6000, () => {
            this.platform.addComponent(new utils.MoveTransformComponent(this.secondFloorPos, this.firstFloorPos, 3, null, utils.InterpolationType.EASEOUTSINE))
        }))
