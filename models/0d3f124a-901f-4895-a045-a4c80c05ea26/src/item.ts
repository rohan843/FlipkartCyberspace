...
export default class Chest implements IScript<Props> {
  openClip = new AudioClip('models/0d3f124a-901f-4895-a045-a4c80c05ea26/sounds/openChest.mp3')
  closeClip = new AudioClip('models/0d3f124a-901f-4895-a045-a4c80c05ea26/sounds/closeChest.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    base.addComponent(new GLTFShape('models/0d3f124a-901f-4895-a045-a4c80c05ea26/models/Chest_Base_01/Chest_Base_01.glb'))
    const top = new Entity('base')
    top.setParent(pivot)
    top.addComponent(
      new Transform({ position: new Vector3(0, offsetY, offsetX) })
    )
    top.addComponent(new GLTFShape('models/0d3f124a-901f-4895-a045-a4c80c05ea26/models/Chest_Top_01/Chest_Top_01.glb'))
