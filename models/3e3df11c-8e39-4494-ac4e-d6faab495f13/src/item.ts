...
export default class Lamp implements IScript<Props> {
  clip = new AudioClip('3e3df11c-8e39-4494-ac4e-d6faab495f13/sounds/Click.mp3')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    let offModel = new GLTFShape('models/3e3df11c-8e39-4494-ac4e-d6faab495f13/models/AtomicLight_Off.glb')
    lampOff.addComponent(offModel)

    const lampOn = new Entity(host.name + '-on')
    lampOn.setParent(host)
    lampOn.addComponent(new Transform())
    let onModel = new GLTFShape('models/3e3df11c-8e39-4494-ac4e-d6faab495f13/models/AtomicLight_On.glb')
