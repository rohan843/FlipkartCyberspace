...
export default class Button implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    billboard.addComponent(new GLTFShape('models/1746d432-ba19-4b2e-819f-d16cf5a64236/models/Screen_Independent.glb'))
    ...
    // let test = new Entity()
    // test.setParent(host)
    // test.addComponentOrReplace(new GLTFShape('models/models/stream_preview.glb'))
    // video material
